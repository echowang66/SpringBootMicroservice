...
public class ProductController {
    ...
    public InternalApiResponse<ProductResponse> updateProduct(@PathVariable("language") Language language, @PathVariable("productId") Long productId, @RequestBody
    ...
    public InternalApiResponse<List<ProductResponse>> getProducts(@PathVariable("language") Language language){
        ...
        log.debug("[{}][updateProducts] -> response: {} {}", this.getClass().getSimpleName(), productResponses);
    ...
    private List<ProductResponse> convertProductResponseList(List<Product> productList){
        return productList.stream()
                .map(arg -> ProductResponse.builder()
                        ...
                        .price(arg.getPrice())
                        .productCreateDate(arg.getProductCreateDate().getTime())
